...
class ABE_Model(nn.Module):
    ...
    def forward(self,x,y):
        ...
        boundary = y_256_256_256 - self.factor * e4_256_256_256
...
if __name__ == '__main__':
    x = torch.randn(size=(2,2048,16,16))
    y = torch.randn(size=(2,64,128,128))
    net = ABE_Model(2048,64,256,256)
    output = net(x,y)
    print(output.shape)